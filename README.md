# Mastering Backend - Build Your Own Blogging API

![Design preview for the Build Your Own Blogging API](https://pub-63da695b9ece47c5b3b49bd78b86d884.r2.dev/Build%20your%20own%20blogging%20api.png)
...
The project is to build **Build Your Own Blogging API** and get the front end working (the front end has already integrated the API).

[Click here to view more details about this project.](https://projects.masteringbackend.com/projects/build-your-own-blogging-api)
...
Your task is to Build Your Own Blogging API. You will find an SQLite database file called `db.sqlite` inside the root folder. You will find the front end of each project on the project description page. 
